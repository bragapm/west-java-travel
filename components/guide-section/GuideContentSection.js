...
export const GuideContentSection = ({ guide }) => {
    ...
    return (
        <section className='flex flex-col items-center px-5 md:px-80 pb-10 md:pb-20' id='content-section'>
            <div className={`md:pt-20 pt-8 ${isShowAllContent ? 'max-h-full' : 'max-h-72'} md:max-h-full max-w-20 overflow-hidden relative`} >
                ...
                {/* <ReactMarkdown className='pt-5 text-neutral font-karla text-sm md:text-lg max-w-20'>{guide.isi_artikel}</ReactMarkdown> */}
