...
export const WhereToGoInFrameSection = ({
  inFrameSectionRef,
  regionId,
  data,
}) => {
...
//   if (error) return <div></div>;
  ...
  return (
    <section
      className='flex flex-col z-10 px-5 md:px-20 mb-10'
      ref={inFrameSectionRef}
      id='in-frame-section'
    >
      <h4 className='capitalize font-montserrat font-bold text-dark text-lg md:text-2.5xl z-10'>
        Central West Java in Frame
      </h4>
          ...
          <div className='rounded-md overflow-hidden relative col-span-2 md:col-span-1 md:row-span-1'>
            <img
              ...
              src={
                images[0] == null
                  ? "/img-placeholder.png"
                  : `https://panel.westjavatravel.com/assets/${images[0].directus_files_id}?key=inframe`
              }
          ...
          <div className='rounded-md overflow-hidden relative col-span-2 md:row-span-2'>
            <img
              ...
              src={
                images[1] == null
                  ? "/img-placeholder.png"
                  : `https://panel.westjavatravel.com/assets/${images[1].directus_files_id}?key=inframe`
              }
              className='w-full h-full object-cover'
            />
          </div>
          <div className='rounded-md overflow-hidden relative col-span-2 md:col-span-1'>
            <img
              ...
              src={
                images[2] == null
                  ? "/img-placeholder.png"
                  : `https://panel.westjavatravel.com/assets/${images[2].directus_files_id}?key=inframe`
              }
              className='w-full h-full object-cover'
            />
          </div>
          <div className='rounded-md overflow-hidden relative col-span-6 md:md:col-span-1'>
            <img
              ...
              src={
                images[3] == null
                  ? "/img-placeholder.png"
                  : `https://panel.westjavatravel.com/assets/${images[3].directus_files_id}?key=inframe`
              }
              className='w-full h-full object-cover'
            />
          </div>
          <div className='rounded-md overflow-hidden relative col-span-2 md:md:col-span-1'>
            <img
              ...
              src={
                images[4] == null
                  ? "/img-placeholder.png"
                  : `https://panel.westjavatravel.com/assets/${images[4].directus_files_id}?key=inframe`
              }
              className='w-full h-full object-cover'
            />
          </div>
          <div className='rounded-md overflow-hidden relative col-span-2 md:md:col-span-1'>
            <img
              ...
              src={
                images[5] == null
                  ? "/img-placeholder.png"
                  : `https://panel.westjavatravel.com/assets/${images[5].directus_files_id}?key=inframe`
              }
              className='w-full h-full object-cover'
            />
          </div>
          <div className='rounded-md overflow-hidden relative col-span-2 md:md:col-span-1'>
            <img
              ...
              src={
                images[6] == null
                  ? "/img-placeholder.png"
                  : `https://panel.westjavatravel.com/assets/${images[6].directus_files_id}?key=inframe`
              }
              className='w-full h-full object-cover'
            />
          </div>
          <div className='rounded-md overflow-hidden relative col-span-3 md:md:col-span-2 md:row-span-2'>
            <img
              ...
              src={
                images[7] == null
                  ? "/img-placeholder.png"
                  : `https://panel.westjavatravel.com/assets/${images[7].directus_files_id}?key=inframe`
              }
              className='w-full h-full object-cover'
            />
          </div>
          <div className='rounded-md overflow-hidden relative col-span-3 md:md:col-span-1'>
            <img
              ...
              src={
                images[8] == null
                  ? "/img-placeholder.png"
                  : `https://panel.westjavatravel.com/assets/${images[8].directus_files_id}?key=inframe`
              }
              className='w-full h-full object-cover'
            />
          </div>
          <div className='rounded-md overflow-hidden relative col-span-2 md:md:col-span-1'>
            <img
              ...
              src={
                images[9] == null
                  ? "/img-placeholder.png"
                  : `https://panel.westjavatravel.com/assets/${images[9].directus_files_id}?key=inframe`
              }
              className='w-full h-full object-cover'
            />
          </div>
          <div className='rounded-md overflow-hidden relative col-span-2 md:md:col-span-1'>
            <img
              ...
              src={
                images[10] == null
                  ? "/img-placeholder.png"
                  : `https://panel.westjavatravel.com/assets/${images[10].directus_files_id}?key=inframe`
              }
              className='w-full h-full object-cover'
            />
          </div>
          <div className='rounded-md overflow-hidden relative col-span-2 md:md:col-span-1'>
            <img
              ...
              src={
                images[11] == null
                  ? "/img-placeholder.png"
                  : `https://panel.westjavatravel.com/assets/${images[11].directus_files_id}?key=inframe`
              }
              className='w-full h-full object-cover'
            />
          </div>
