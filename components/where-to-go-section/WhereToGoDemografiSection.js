...
export const WhereToGoDemografiSection = ({ demografiSectionRef }) => {
    return (
        <section className='md:pt-16 pt-8 md:ml-9 max-h-72 md:max-h-full overflow-hidden' ref={demografiSectionRef} id='demografi-section'>
            <h4 className='font-montserrat font-bold text-dark text-xl md:text-2xl'>Demografi</h4>
            ...
            <h4 className='pt-5 font-montserrat font-bold text-dark text-xl md:text-2xl capitalize'>Akses Masuk Ke Southern West Java</h4>
            <p className='pt-5 text-neutral font-karla text-sm md:text-lg'>Kalau Sobat Pesona yang ingin mencari spot foto yang manis dan penuh warna pastel yang kekinian, kunjungi saja Rabbit Town! Selain itu ada pula Bandung Amazing Art World yang menyediakan latar foto instagrammable dengan efek 3D hingga wahana Dunia Terbalik nan unik. </p>
