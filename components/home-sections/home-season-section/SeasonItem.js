...
export const SeasonItem = ({ seasonData }) => {
    ...
    return (
        <Link href={`/destination/${seasonData.id}`}>
            <div className='h-[293px] md:h-[450px] w-[50vw] md:w-[40vw] lg:w-[30vw] xl:w-[20vw] flex-none overflow-hidden relative group cursor-pointer'>
