    ...
    return (
        <section className='pt-20 md:pt-36'>
            <div className='flex flex-col md:flex-row divide-y md:divide-y-0 md:divide-x divide-bordercolor'>
                <div className='flex flex-col px-5 md:pl-20 md:pr-10 md:w-7/12 items-center'>
                ...
                <div className='flex flex-col pt-8 md:pt-0 md:w-5/12 md:h-[600px]'>
                    <h3 className='font-bold text-dark text-xl md:text-2xl font-montserrat mb-5 md:mb-8 ml-5 md:ml-10'>Rekomendasi Tips</h3>
                    <div className='recommendation-item flex flex-row md:flex-col gap-4 md:gap-8 px-5 md:pr-20 md:pl-10 md:h-full md:justify-between md:pb-20'>
                        {dummyTravelRecommendationData.map((recommendation, indx) => {
                            return <div
                                key={indx}
                                className='flex flex-col md:flex-row-reverse flex-none max-w-[254px] md:max-w-full md:justify-between'>
