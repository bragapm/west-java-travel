...
export const DestinationDetailHeadSection = ({ destination }) => {
    ...
    return (
        <section>
            <img src={`${destination.images ? destination.images.length > 0 ? `https://panel.westjavatravel.com/assets/${destination.images[0].directus_files_id}` : '/img-about-thumbnail.jpg' : '/img-about-thumbnail.jpg'} `} className='h-[306px] md:h-[500px] w-full object-cover' />
            <div className='flex flex-col items-start md:items-center px-5 md:px-80'>
